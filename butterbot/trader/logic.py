...
from trader.models import Event, Market, Runner, Book, RunnerBook
# \Market, Book, Runner, RunnerBook, Accuracy, Bucket, Bet


from trader.client import get_betfair_client , ET_HORSE_RACING , ET_GREYHOUND_RACING, ET_TENNIS
...
class BFCommand(BaseCommand):
    ...
    def betfair_get(self , is_ip , counter , sport='Tennis'):
        ...
        markets = trading.list_market_catalogue(
        ...
        for mp in mids_portions:
            print(','.join(mp))
            books = trading.list_market_book(mp , price_projection=PriceProjection(
